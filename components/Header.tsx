...
export default function Header() {
  ...
  return (
    <motion.header
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled || !isHome || mobileMenuOpen ? 'bg-didi-black/90 backdrop-blur-md shadow-lg' : 'bg-transparent'
        }`}
    >
